...
INSERT INTO Agriturismo VALUES ('Borgo Tramonte'),
('Le Valli di Castelfiorentino'),
('Campetroso'),
...
('Renello'),
('Eco Organic Resort and Luxury Glamping Sant Egle'),
('Podere la Piana'),
('Renai e Monte'),
('Il Greppo'),
('I Pianelli'),
...
INSERT INTO Stalla SELECT FLOOR(RAND()*5), A.nome
...
INSERT INTO CaratteristichePerTipoLocale 
		...
		ELT(0.5 + RAND()*20, 'lavorazione su rilievi antiscivolo con lavorazione su rilievi antiscivolo',
							...
							'tappeti in gomma con mattonelle in gres',
							'rigatura con piena in cemento',
							'porfido con piena in cemento',
							'mattonelle in gres con piena in cemento',
							'mattonelle in gres con rigatura',
							'grigliato con piena in cemento',
							'lavorazione su rilievi antiscivolo con lavorazione su rilievi antiscivolo',
							'tappeti in gomma con rigatura',
							'lavorazione su rilievi antiscivolo con trattamento antiscivolo',
							'tappeti in gomma con tappeti in gomma',
							'resine epissidiche con porfido',
							'grigliato con porfido',
							'lavorazione su rilievi antiscivolo con grigliato',
							'resine epissidiche con tappeti in gomma',
							'resine epissidiche con trattamento antiscivolo',
							'trattamento antiscivolo con resine epissidiche',
							'porfido con mattonelle in gres')
