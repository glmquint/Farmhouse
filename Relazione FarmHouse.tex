...
Nota sugli attributi:\\Per sfruttare i tipi di dato offerti dall'architettura mySQL, si è deciso di trasformare tutte le istanze di data e orario in un unico attributo data-orario di tipo TIMESTAMP.
